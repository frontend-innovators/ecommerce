  ...
  return (
    <div className="flex flex-col sm:flex-row-reverse md:flex-col lg:flex-row lg:flex-row-reverse">
        <div className='bg-[#feeb9d] h-80 sm:h-96 w-[100vw] sm:w-[70vw] m-auto relative md:w-[100vw] lg:w-[70vw] '>
            <svg className="absolute left-[10px] top-[-17px] sm:right-[280px] top-[-8] w-40 sm:w-full
             md:w-[300px] md:right-[450px] lg:w-[400px] lg:right-[32vw] lg:top-[-4px]" xmlns="http://www.w3.org/2000/svg" width="413" height="44" viewBox="0 0 413 44" fill="none"><path d="M37.4829 37.8579L0 0.375V0H413V0.375L375.517 37.8579C367.707 45.6684 355.043 45.6684 347.233 37.8579L323.892 14.5171C316.082 6.70665 303.418 6.70665 295.608 14.5171L272.267 37.8579C264.457 45.6684 251.793 45.6684 243.983 37.8579L220.642 14.5171C212.832 6.70665 200.168 6.70665 192.358 14.5171L169.017 37.8579C161.207 45.6684 148.543 45.6684 140.733 37.8579L117.392 14.5171C109.582 6.70665 96.9184 6.70665 89.1079 14.5171L65.7671 37.8579C57.9566 45.6684 45.2934 45.6684 37.4829 37.8579Z" fill="#FFFAF3"/></svg>
