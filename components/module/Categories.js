        ...
        <div className='bg-[#feeb9d] h-80 sm:h-96 w-[100vw] sm:w-[70vw] m-auto relative md:w-[100vw] lg:w-[70vw] '>
            ...
            <div className=" mt-[80px] gap-[50px] pr-28 pl-28">
                <div className=" pr-28 pl-28">
                    ...
                    loopedSlides={repeatedCategories.length} loop={true} navigation={{ nextEl: ".next-btn",prevEl: ".prev-btn"}}
                    breakpoints={{ 0: {slidesPerView: 2,}, 640: {slidesPerView: 3,}, 768: {slidesPerView: 3,},1024: {slidesPerView: 4,},}}
                    slidesPerView={4}>
